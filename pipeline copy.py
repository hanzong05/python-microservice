...
class GeotechnicalPipeline:
    ...
    def store_soil_layers(self) -> bool:
        """
        Insert soil layer records into the DB.
        All schema columns are now populated, including:
        ...
        for _, row in df.iterrows():
            ...
            record = {
                ...
                # ── FIX: previously missing fields now populated ──────────
                ...
                # ── Remarks (lightweight audit trail) ─────────────────────
                # cleared; all data now in proper columns
                'remarks':                       None,
            }
        ...
        print(
            f"    [OK] factor_of_safety, liquefaction_probability, liquefaction_status,")
        print(f"         spt_is_refusal, spt_is_imputed, is_core_sample, is_rock now populated.")
        return True
